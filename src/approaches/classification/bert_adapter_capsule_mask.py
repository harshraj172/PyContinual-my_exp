...
class Appr(ApprBase):
    ...
    def train(self,t,train,valid,num_train_steps,train_data,valid_data):
        ...
        for e in range(int(self.args.num_train_epochs)):
            ...
            target_list,pred_list,train_loss,train_acc,train_f1_macro=self.eval(t,train)
            clock2=time.time()
            ...
            target_list,pred_list,valid_loss,valid_acc,valid_f1_macro=self.eval(t,valid)
