...
def asc_config(parser):
    ...
    parser.add_argument('--domain_type',default='domain-type',type=str,required=False,help='(default=%(default)s)')  ##
    ...
    parser.add_argument('--ntasks',default=5,type=int,required=False,help='(default=%(default)d)')
    ...
    parser.add_argument('--base_resume_from_aux_file',type=str,default='')
    parser.add_argument('--base_resume_from_file',type=str,default='')
